    ...
    <>
      ...
      <section id="projects" className="section-spacing c-space flex flex-col items-center justify-center min-h-screen">
        <div className="relative group w-full max-w-3xl">
          {/* Ambient Glow */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-royal via-lavender to-mint rounded-[2.1rem] blur-xl opacity-15 group-hover:opacity-30 transition duration-700 pointer-events-none" />
          
          <div className="relative w-full bg-gradient-to-br from-[#06091f]/95 via-[#0c0f2a]/95 to-[#161a31]/95 rounded-[2rem] p-8 md:p-10 flex flex-col items-center border border-white/10 backdrop-blur-2xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.6)]">
            <motion.h1 
              ...
              className="text-3xl md:text-4xl mb-4 text-center font-extrabold tracking-tight bg-gradient-to-r from-white via-lavender to-royal bg-clip-text text-transparent cursor-default drop-shadow-[0_0_15px_rgba(122,87,219,0.35)]"
            >
              Socketly
            </motion.h1>

            {/* Tech Stack Dock Capsule */}
            <div className="flex flex-wrap gap-4 justify-center mb-8 px-6 py-4 bg-white/[0.03] border border-white/10 rounded-2xl backdrop-blur-md shadow-lg shadow-black/30">
              {techStack.map((tech) => {
                // Custom brand glows on hover
                const hoverGlow = {
                  'MongoDB': 'group-hover/tech:shadow-[0_0_20px_rgba(87,219,150,0.3)] group-hover/tech:border-mint/40',
                  'Express': 'group-hover/tech:shadow-[0_0_20px_rgba(255,255,255,0.2)] group-hover/tech:border-white/30',
                  'React': 'group-hover/tech:shadow-[0_0_20px_rgba(51,194,204,0.3)] group-hover/tech:border-aqua/40',
                  'Node.js': 'group-hover/tech:shadow-[0_0_20px_rgba(87,219,150,0.3)] group-hover/tech:border-mint/40',
                  'Socket.IO': 'group-hover/tech:shadow-[0_0_20px_rgba(255,255,255,0.2)] group-hover/tech:border-white/30',
                  'TailwindCSS': 'group-hover/tech:shadow-[0_0_20px_rgba(51,194,204,0.3)] group-hover/tech:border-aqua/40',
                }[tech.name] || 'group-hover/tech:shadow-[0_0_20px_rgba(92,51,204,0.3)] group-hover/tech:border-royal/40';

                return (
                  <div key={tech.name} className="flex flex-col items-center group/tech cursor-pointer">
                    <div className={`w-12 h-12 rounded-xl bg-white/[0.02] border border-white/10 p-2.5 flex items-center justify-center transform group-hover/tech:scale-110 group-hover/tech:-translate-y-1 transition-all duration-300 shadow-md ${hoverGlow}`}>
                      <img src={tech.icon} alt={tech.name} className="w-full h-full object-contain filter drop-shadow-md" />
                    </div>
                    <span className="text-[10px] uppercase tracking-wider font-semibold text-neutral-500 mt-2 group-hover/tech:text-neutral-200 transition-colors duration-250">{tech.name}</span>
                  </div>
                );
              })}
            </div>
            ...
            <div className="w-full max-w-md mb-6 flex flex-col items-center">
              <div
                ...
                className="group/img relative w-full rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(92,51,204,0.15)] group-hover:border-royal/50 group-hover:shadow-[0_0_40px_rgba(92,51,204,0.3)] aspect-video bg-midnight/80 flex items-center justify-center cursor-zoom-in transition-all duration-500"
              >
                ...
                {/* Zoom Hover Overlay */}
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover/img:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-2 text-white text-sm font-light backdrop-blur-[2px]">
              ...
              {/* Tab Switched Pills */}
              <div className="flex gap-2 mt-4 p-1.5 bg-white/[0.02] border border-white/10 backdrop-blur-md rounded-full shadow-inner">
                {[
                  ...
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-xs font-semibold cursor-pointer transition-all duration-250 ${activeImage === tab.id
                      ? 'bg-gradient-to-r from-royal to-lavender text-white shadow-md shadow-royal/30 scale-105'
            ...
            <p className="subtext text-center mb-6 max-w-xl leading-relaxed text-pretty text-neutral-300">
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-2 w-full">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-2.5 text-sm font-bold rounded-xl bg-gradient-to-r from-mint to-aqua text-primary hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 shadow-lg shadow-mint/20 hover:shadow-mint/45 flex items-center justify-center gap-2 cursor-pointer min-w-[9rem]"
              >
      ...
      <section className="section-spacing c-space flex flex-col items-center justify-center min-h-screen">
        <div className="relative group w-full max-w-3xl mt-10">
          {/* Ambient Glow */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-coral via-orange to-fuchsia rounded-[2.1rem] blur-xl opacity-15 group-hover:opacity-30 transition duration-700 pointer-events-none" />

          <div className="relative w-full bg-gradient-to-br from-midnight via-[#0e0c1f] to-navy rounded-[2rem] shadow-2xl p-8 md:p-10 flex flex-col items-center border border-white/10 backdrop-blur-2xl">
            <motion.h1 
              initial={{ opacity: 0, y: -10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              whileHover={{ scale: 1.05, filter: "drop-shadow(0 0 15px rgba(92,51,204,0.5))" }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="text-3xl md:text-4xl mb-4 text-center font-extrabold tracking-tight bg-gradient-to-r from-white via-coral to-fuchsia bg-clip-text text-transparent cursor-default drop-shadow-[0_0_15px_rgba(234,72,132,0.35)]"
            >
              Media Morph
            </motion.h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-8 px-6 py-4 bg-white/[0.03] border border-white/10 rounded-2xl backdrop-blur-md shadow-lg shadow-black/30">
              {[
                ...
                // Custom brand glows on hover
                const hoverGlow = {
                  'Next.js': 'group-hover/tech:shadow-[0_0_20px_rgba(255,255,255,0.2)] group-hover/tech:border-white/30',
                  'TypeScript': 'group-hover/tech:shadow-[0_0_20px_rgba(49,120,198,0.3)] group-hover/tech:border-indigo-400/40',
                  'React': 'group-hover/tech:shadow-[0_0_20px_rgba(51,194,204,0.3)] group-hover/tech:border-aqua/40',
                  'TailwindCSS': 'group-hover/tech:shadow-[0_0_20px_rgba(51,194,204,0.3)] group-hover/tech:border-aqua/40',
                  'Cloudinary': 'group-hover/tech:shadow-[0_0_20px_rgba(243,112,42,0.3)] group-hover/tech:border-orange-500/40',
                }[tech.name] || 'group-hover/tech:shadow-[0_0_20px_rgba(92,51,204,0.3)] group-hover/tech:border-royal/40';
            ...
            <div
              ...
              className="group/img relative w-full max-w-md mb-6 rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(234,72,132,0.15)] group-hover:border-coral/50 group-hover:shadow-[0_0_40px_rgba(234,72,132,0.3)] cursor-zoom-in transition-all duration-500"
            >
              <img
              ...
              {/* Zoom Hover Overlay */}
              <div className="absolute inset-0 bg-black/50 opacity-0 group-hover/img:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-2 text-white text-sm font-light backdrop-blur-[2px]">
                <svg className="w-5 h-5 text-coral animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v6m3-3H7" />
                </svg>
                Click to Zoom
              </div>
            ...
            <p className="subtext text-center mb-6 max-w-xl leading-relaxed text-neutral-300">
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-2 w-full">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-2.5 text-sm font-bold rounded-xl bg-gradient-to-r from-coral to-fuchsia text-white hover:scale-105 hover:-translate-y-0.5 transition-all duration-300 shadow-lg shadow-coral/20 hover:shadow-coral/45 flex items-center justify-center gap-2 cursor-pointer min-w-[9rem]"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.9-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.9 1.52 2.34 1.07 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0012 2z" />
                </svg>
